...
def hecras_like_steady_profile(
    ...
    for _, qrow in q_design.iterrows():
        ...
        df_ds = _section_points(points_df, ds_id)
        ...
        # Guardar DS
        results.append(_row_output(ds, T, Q, p_ds, V_ds, E_ds, n_manning, 0.0, 0.0, "borde_aguas_abajo"))
        ...
        for idx in range(len(sec) - 2, -1, -1):
            ...
            df_up = _section_points(points_df, up_id)
...
def _row_output(sec_row, T, Q, props, V, E, n, hf, hlocal, metodo):
